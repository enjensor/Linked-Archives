...
///////////////////////////////////////////////////////////// UPDATE Function
	...
	if(($action == "EDIT_UPDATE") 
	   	&& ($annotations_reg_uri != "") && ($annotations_rdfs_label != "") && ($annotations_value_string != "") 
	   	&& ($data_edit_tag_key != "") && ($data_edit_tag_value != "") && ($data_edit_tag_all != "")) {	
...
///////////////////////////////////// If 2nd and 3rd Additions			
			...
			if(($data_edit_tag_key_two != "") && ($data_edit_tag_value_two != "")) {
				$additionsRefs = array();
				$a_old_reg_uri = $annotations_reg_uri;
				$a_old_rdfs_label = $annotations_rdfs_label;
				$a_old_value_string = $annotations_value_string;		
...
///////////////////////////////////////////////////////////// EDIT Function
	...
	if(($action == "EDIT" or $action == "EDIT_UPDATE") 
	   	&& ($annotations_reg_uri != "") && ($annotations_rdfs_label != "") && ($annotations_value_string != "")){		
...
///////////////////////////////////// Table Header						
                                ...
                                echo "<tr>";
                                echo "<td style=\"font-size: 1.0em; text-align:left; color: #ffffff; background-color: #9C2929; "; 
                                ...
                                echo "&nbsp;<strong>Edit Mention</strong>";
                                echo "</td>";
                                echo "</tr>";
...
///////////////////////////////////// Update All Instances Text
                                    ...
                                    echo "The Key / Value pair of <strong><span style=\"color: #AA0000;\">$old_reg_uri"." : "."$old_rdfs_label</span></strong> ";
                                    echo "and <strong><span style=\"color: #AA0000;\">$old_value_string</span></strong> ";
                                    echo "occurs in <strong><span style=\"color: #AA0000;\">".number_format($aCount, 0)."</span></strong> places throughout the database. Please select a different Key and / or edit the Value above and then click the 'Save Changes' button to make changes to this mention.<br />&nbsp;"; 
                                    echo "</td>";
                                    echo "</tr>";	
...
///////////////////////////////////// Update All Instances Tick Box
                                    ...
                                    echo "<tr>";
                                    echo "<td style=\"font-size: 1.0em; text-align:right; border-top: 0px solid #768697; vertical-align: middle;\" nowrap>&nbsp;</td>";
                                    echo "<td style=\"text-align: right; padding-bottom: 15px; padding-top: 3px; padding-left: 5px; padding-right: 0px;\">";
...
///////////////////////////////////// Table Header						
                                ...
                                echo "vertical-align: middle; padding-right: 6px; padding: 12px; -webkit-border-radius: 8px; -moz-border-radius: 8px; border-radius: 8px;\" colspan=\"2\">";	
                                echo "&nbsp;<strong>Split Mention</strong>";
                                echo "</td>";
                                echo "</tr>";                           
...
?>                            
                		...
                		<p style=" -webkit-border-radius: 8px; -moz-border-radius: 8px; border-radius: 8px; 
                    		...
                    		need to be split into two or three 'mentions'. In these instances, please add the first of the 'mentions' in the left-hand panel as usual, 
...
///////////////////////////////////////////////////////////// Submit Item Data
				...
				$("#edit-submit-item").click(function(event) {
					...
					var dataAll = "action=EDIT_UPDATE"
						...
						+"&annotations_reg_uri=<?php echo $annotations_reg_uri; ?>"
						+"&annotations_rdfs_label=<?php echo $annotations_rdfs_label; ?>"
						+"&annotations_value_string=<?php echo $annotations_value_string; ?>";
					
					var doEditMe = $('#EditMetaPanel').fadeOut('fast', function(){ 
						var doEditMeB = $('#EditMetaPanel').load('./data_meta_review.php',dataAll, function(){ 
