...
//////////////////////////////////////////// CREATE ARRAY
	...
	$archival = dir("C:\\Temp\\Whitcomb\\MS 2011_25 (Whitcoulls Archive 2)\\");
	$Qfiles = array();
...
//////////////////////////////////////////// FOLDER VARS
		...
		$start = time();
		$x = 0;
		$dirx = "C:\\Temp\\Whitcomb\\MS 2011_25 (Whitcoulls Archive 2)\\".$QQ."\\";
		$dirz = "C:\\Temp\\Whitcomb\\MS 2011_25 (Whitcoulls Archive 2)\\".$QQ;
		$folder = dir("$dirx"); 
		$folderMain = "$dirz"; 
...
//////////////////////////////////////////// COLLECTION VARS		
		...
		$col_bf_physicalLocation = "Whitcoulls Archive 2";
		$col_skos_collection = "$Trow[0], $Scz[0]";
		$col_skos_orderedCollection = "MS 2011/25";
